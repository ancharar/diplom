...
class ReportTaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ReportTask
        fields = ['id', 'report', 'task', 'task_id', 'status_before', 
                  'status_after', 'time_spent', 'comment']
...
class ReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Report
        fields = [
            'id', 'template', 'template_title', 'template_frequency',
            'user', 'period_start', 'period_end', 'deadline',
            'answers', 'status', 'status_display', 'is_overdue',
            'submitted_at', 'reviewed_by', 'reviewed_at', 'review_comment',
            'tasks_data', 'report_tasks', 'created_at', 'updated_at'
        ]
        read_only_fields = [
...
class ReportSubmitSerializer(serializers.Serializer):
    ...
    tasks_data = serializers.JSONField(required=False, default=dict)
